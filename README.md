...
Just build file Zoinho.asm, all dependencies are defined in this file include statement list. The resulting build (Zoinho.tap) should constain the entire game.

To build the whole executable, including the BASIC loader and loading screen, you will have to stitch together all 3 .TAP files together in a single .TAP:

. zoinho-BASIC-loader.tap
. ZoinhoLoadingScreen.tap
. Zoinho.tap

NB: Application "ZX-BlockEdit" can be used to stitch all .TAP files together.
