...
; =================================================================================
; INCLUDE - SwimWakeSpriteData_I01
; =================================================================================

; =================================================================================
; SwimWake - SPRITE - X AXIS - FRONT (1,2) - 24 x 24 pixels (= 3 x 3 attributes)
; =================================================================================

; ---------------------------------------------------------------------------------
; Memory Alloc: SwimWake sprite data
SwimWakeSpriteData:

; ---------------------------------------------------------------------------------
; Memory Alloc: SwimWake (Sprite pixels)

SwimWake:

; Interleaved

DB 0xBF, 0x00, 0xFF, 0x00, 0xFB, 0x00, 0x0F, 0x40, 0xFF, 0x00, 0xC1, 0x04, 0x84, 0x10, 0xFF, 0x00, 0x01, 0x30, 0x00, 0x43, 0x20, 0x00, 0x00, 0x82, 0x80, 0x18, 0x00, 0x5E, 0x01, 0x08, 0xE0, 0x02, 0x81, 0x00, 0x07, 0x60, 0xBD, 0x00, 0x80, 0x2A, 0x9E, 0x00, 0xF7, 0x00, 0xD5, 0x00, 0xFB, 0x00